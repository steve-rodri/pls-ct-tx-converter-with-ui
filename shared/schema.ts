...
export const walletAddressSchema = z.string().trim().min(10, "Wallet address must be at least 10 characters");

export const csvFileSchema = z.instanceof(File).refine(
